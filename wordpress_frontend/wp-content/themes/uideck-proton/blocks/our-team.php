<?php
	/**
	 * UIDECK Proton blocks for our team.
	 *
        ...
        <div class="row">
            ...
            <div class="single-team wow fadeInUp" data-wow-delay="0.2s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Joseph Ronald Calara</h4>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Michael Ian Belaguin</h4>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.4s">
              ...
              <div class="team-details">
                <div class="team-inner">                  
                  <h4 class="team-title">Caezar De Castro II</h4>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.5s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Maria Eleanor Gutierrez</h4>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.5s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Pauline Flores</h4>
