        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p>Do you need to build lists for your email campaigns? It just got easier with PasaBuy.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                    ...
                    <div class="form-container">
                        <form id="requestForm" data-toggle="validator" data-focus="false">
                            ...
                            <div class="form-group checkbox">
                                <input type="checkbox" id="rterms" value="Agreed-to-Terms" name="rterms" required>I agree with PasaBuy's stated <a href="<?php echo site_url() . '/privacy-policy'; ?>">Privacy Policy</a> and <a href="<?php echo site_url() . '/terms-and-conditions'; ?>">Terms & Conditions</a>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">I just finished my trial period and was so amazed with the support and results that I purchased PasaBuy right away at the special price.</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">PasaBuy has always helped or startup to position itself in the highly competitive market of mobile applications. You will not regret using it!</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">Love their services and was so amazed with the support and results that I purchased PasaBuy for two years in a row. They are awesome.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I have read and agree with PasaBuy's stated <a href="<?php echo site_url() . '/privacy-policy'; ?>">Privacy Policy</a> and <a href="#terms">Terms Conditions</a> 
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
