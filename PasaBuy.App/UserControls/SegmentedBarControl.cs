        ...
        void LoadChildrens()
        {
            ...
            foreach (var item in Children)
            {
                var label = new Label()
                {
                    ...
                    FontFamily = Device.RuntimePlatform == Device.iOS ? "Poppins-Regular" :
                                   Device.RuntimePlatform == Device.Android ? "Nunito-Regular.ttf#Nunito-Regular" : "Assets/Nunito-Regular.ttf#Nunito",
                    Text = item,
                    TextColor = TextColor,
                ...
                label.FontSize = Device.RuntimePlatform == Device.iOS ? 13 :
