...
namespace PasaBuy.App.ViewModels.Currency
{
    ...
    public class WalletCreditViewModel : BaseViewModel
    {
        ...
        public WalletCreditViewModel()
        {
            ...
            //Console.WriteLine("DateTime: 2020-10-07 " + "2020-10-07 16:25:02".Substring(0, 4) + " 5-2." + "2020-10-07 16:25:02".Substring(5, 2) + " 8-2." + "2020-10-07 16:25:02".Substring(8, 2));
        ...
        public void CreateWallet()
        {
            try
            {
                CoinPress.Wallet.Instance.Create(PSACache.Instance.UserInfo.wpid, PSACache.Instance.UserInfo.snky, "CDT", async (bool success, string data) =>
                {
                    if (success)
                    {
                        WalletCreditsModel wallet = JsonConvert.DeserializeObject<WalletCreditsModel>(data);
        ...
        public void LoadBalance()
        {
            try
            {
                CoinPress.Wallet.Instance.Balance(PSACache.Instance.UserInfo.wpid, PSACache.Instance.UserInfo.snky, "CDT", (bool success, string data) =>
                {
                    if (success)
                    {
                        WalletCreditsModel wallet = JsonConvert.DeserializeObject<WalletCreditsModel>(data);
