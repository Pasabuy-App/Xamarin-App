...
namespace PasaBuy.App.ViewModels.Driver
{
    ...
    public class DriverRecentChatViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// </summary>
        public DriverRecentChatViewModel()
        {
        ...
        {
            //((MainTabs)App.Current.MainPage).Navigation.PushModalAsync(new NavigationPage(new DriverChatMessagePage()));
