using PasaBuy.App.Models.StoreDetail;
using System.Collections.ObjectModel;
using System.Runtime.Serialization;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace PasaBuy.App.ViewModels.StoreDetail
{
    ...
    public class StoreDetailPageViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="StoreDetailPageViewModel"/> class.
        /// </summary>
        ...
        public ObservableCollection<Models.StoreDetail.StoreDetail> MoviesList { get; set; }
        ...
        public ObservableCollection<Models.StoreDetail.StoreDetail> RotatorMoviesList { get; set; }

        /// <summary>
        /// Gets or sets a collection of value to be displayed in now showing list of movies page.
        /// </summary>
        [DataMember(Name = "showingMoviesList")]
        public ObservableCollection<Models.StoreDetail.StoreDetail> NowShowingMoviesList { get; set; }

        /// <summary>
        /// Gets or sets a collection of value to be displayed in the trailer list of movies page.
        /// </summary>
        [DataMember(Name = "trailerMoviesList")]
        public ObservableCollection<Models.StoreDetail.StoreDetail> TrailerMoviesList { get; set; }
        ...
        public ObservableCollection<Models.StoreDetail.StoreDetail> UpcomingMoviesList { get; set; }
