...
namespace PasaBuy.App.ViewModels.Feeds
{
    ...
    public class MyProfileViewModel : BaseViewModel
    {
        ...
        public MyProfileViewModel()
        {
            ...
            this.MenuBackCommand = new Command(this.MenuBackClicked);
        ...
        /// <summary>
        /// Invoked when the menu back button is clicked.
        /// </summary>
        /// <param name="obj">The Object</param>
        private void MenuBackClicked(object obj)
        {
